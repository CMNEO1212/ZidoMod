    ...
    public class Recipe
    {
        ...
        public static void FindRecipes()
        {
            ...
            if (ZidoMod.showAllRecipes)
            {
                ...
                {
                    Main.availableRecipe[i] = 1;
                }
                Main.numAvailableRecipes = numRecipes;
                return;
            }
        ...
        public static void SetupRecipes()
        {
            ...
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1a6, false);
            newRecipe.createItem.stack = 5;
            newRecipe.requiredItem[0].SetDefaults("Bottled Water");
            newRecipe.requiredItem[1].SetDefaults(0x1f5, false);
            newRecipe.requiredItem[1].stack = 5;
            newRecipe.requiredItem[2].SetDefaults(0x171, false);
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1a7, false);
            newRecipe.createItem.stack = 5;
            newRecipe.requiredItem[0].SetDefaults("Bottled Water");
            newRecipe.requiredItem[1].SetDefaults(370, false);
            newRecipe.requiredItem[2].SetDefaults(0x3b, false);
            addRecipe();
            ...
            newRecipe.requiredItem[2].SetDefaults(0x1f6, false);
            newRecipe.requiredTile[0] = 13;
            addRecipe();
            ...
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x221, false);
            newRecipe.createItem.stack = 15;
            newRecipe.requiredItem[0].SetDefaults(40, false);
            newRecipe.requiredItem[0].stack = 15;
            newRecipe.requiredItem[1].SetDefaults(0x20a, false);
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x204, false);
            newRecipe.createItem.stack = 0x23;
            newRecipe.requiredItem[0].SetDefaults(40, false);
            newRecipe.requiredItem[0].stack = 0x23;
            newRecipe.requiredItem[1].SetDefaults(0x1f5, false);
            newRecipe.requiredItem[1].stack = 6;
            newRecipe.requiredItem[2].SetDefaults(0x20e, false);
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            ...
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x203, false);
            newRecipe.createItem.stack = 0x19;
            newRecipe.requiredItem[0].SetDefaults("Musket Ball");
            newRecipe.requiredItem[0].stack = 0x19;
            newRecipe.requiredItem[1].SetDefaults(0x1f6, false);
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x222, false);
            newRecipe.createItem.stack = 0x19;
            newRecipe.requiredItem[0].SetDefaults("Musket Ball");
            newRecipe.requiredItem[0].stack = 0x19;
            newRecipe.requiredItem[1].SetDefaults(0x20a, false);
            ...
            addRecipe();
            newRecipe.createItem.SetDefaults(0x20b, false);
            newRecipe.createItem.stack = 0x21;
            newRecipe.requiredItem[0].SetDefaults(8, false);
            newRecipe.requiredItem[0].stack = 0x21;
            newRecipe.requiredItem[1].SetDefaults(0x20a, false);
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1ab, false);
            newRecipe.createItem.stack = 3;
            newRecipe.requiredItem[0].SetDefaults(8, false);
            newRecipe.requiredItem[0].stack = 3;
            newRecipe.requiredItem[1].SetDefaults(0xb1, false);
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1ac, false);
            newRecipe.createItem.stack = 3;
            newRecipe.requiredItem[0].SetDefaults(8, false);
            newRecipe.requiredItem[0].stack = 3;
            newRecipe.requiredItem[1].SetDefaults(0xb2, false);
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1ad, false);
            newRecipe.createItem.stack = 3;
            newRecipe.requiredItem[0].SetDefaults(8, false);
            newRecipe.requiredItem[0].stack = 3;
            newRecipe.requiredItem[1].SetDefaults(0xb3, false);
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1b0, false);
            newRecipe.createItem.stack = 3;
            newRecipe.requiredItem[0].SetDefaults(8, false);
            newRecipe.requiredItem[0].stack = 3;
            ...
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1af, false);
            newRecipe.createItem.stack = 3;
            newRecipe.requiredItem[0].SetDefaults(8, false);
            newRecipe.requiredItem[0].stack = 3;
            ...
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x188, false);
            ...
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x19c, false);
            newRecipe.requiredItem[0].SetDefaults(0x198, false);
            newRecipe.requiredItem[1].SetDefaults(0x199, false);
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1a1, false);
            newRecipe.createItem.stack = 4;
            newRecipe.requiredItem[0].SetDefaults(0x19c, false);
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x19d, false);
            newRecipe.requiredItem[0].SetDefaults(3, false);
            newRecipe.requiredItem[1].SetDefaults(0xac, false);
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1a2, false);
            newRecipe.createItem.stack = 4;
            newRecipe.requiredItem[0].SetDefaults(0x19d, false);
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x19e, false);
            newRecipe.requiredItem[0].SetDefaults(3, false);
            newRecipe.requiredItem[1].SetDefaults(0xb0, false);
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1a3, false);
            newRecipe.createItem.stack = 4;
            newRecipe.requiredItem[0].SetDefaults(0x19e, false);
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x19f, false);
            newRecipe.requiredItem[0].SetDefaults(3, false);
            newRecipe.requiredItem[1].SetDefaults(0x16c, false);
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(420, false);
            newRecipe.createItem.stack = 4;
            newRecipe.requiredItem[0].SetDefaults(0x19f, false);
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1a0, false);
            newRecipe.requiredItem[0].SetDefaults(3, false);
            newRecipe.requiredItem[1].SetDefaults(0x16d, false);
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1a5, false);
            newRecipe.createItem.stack = 4;
            newRecipe.requiredItem[0].SetDefaults(0x1a0, false);
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x241, false);
            newRecipe.createItem.stack = 5;
            newRecipe.requiredItem[0].SetDefaults(0x38, false);
            newRecipe.requiredItem[1].SetDefaults(0x3d, false);
            newRecipe.requiredItem[1].stack = 5;
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(0xb0, false);
            ...
            newRecipe.requiredItem[0].stack = 10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1df, false);
            newRecipe.createItem.stack = 4;
            newRecipe.requiredItem[0].SetDefaults(3, false);
            newRecipe.requiredItem[0].stack = 1;
            newRecipe.requiredItem[1].SetDefaults(9, false);
            ...
            newRecipe.requiredTile[0] = 0x6a;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1f2, false);
            newRecipe.requiredItem[0].SetDefaults(9, false);
            newRecipe.requiredItem[0].stack = 20;
            newRecipe.requiredTile[0] = 0x6a;
            addRecipe();
            ...
            newRecipe.requiredItem[0].SetDefaults(0xc6, false);
            newRecipe.requiredItem[1].SetDefaults(0x1f6, false);
            newRecipe.requiredItem[1].stack = 50;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults("Red Phasesaber");
            newRecipe.requiredItem[0].SetDefaults(0xc7, false);
            newRecipe.requiredItem[1].SetDefaults(0x1f6, false);
            newRecipe.requiredItem[1].stack = 50;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            ...
            newRecipe.requiredItem[0].SetDefaults(0xc9, false);
            newRecipe.requiredItem[1].SetDefaults(0x1f6, false);
            newRecipe.requiredItem[1].stack = 50;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults("White Phasesaber");
            newRecipe.requiredItem[0].SetDefaults(0xca, false);
            newRecipe.requiredItem[1].SetDefaults(0x1f6, false);
            newRecipe.requiredItem[1].stack = 50;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults("Yellow Phasesaber");
            newRecipe.requiredItem[0].SetDefaults(0xcb, false);
            newRecipe.requiredItem[1].SetDefaults(0x1f6, false);
            newRecipe.requiredItem[1].stack = 50;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            ...
            newRecipe.requiredItem[0].SetDefaults(0xb3, false);
            newRecipe.requiredItem[0].stack = 1;
            newRecipe.requiredItem[1].SetDefaults(0xb1, false);
            newRecipe.requiredItem[1].stack = 1;
            newRecipe.requiredItem[2].SetDefaults(0x14b, false);
            newRecipe.requiredItem[2].stack = 8;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0xe5, false);
            newRecipe.requiredItem[0].SetDefaults(0xb2, false);
            newRecipe.requiredItem[0].stack = 1;
            newRecipe.requiredItem[1].SetDefaults(0xb6, false);
            newRecipe.requiredItem[1].stack = 1;
            newRecipe.requiredItem[2].SetDefaults(0x14b, false);
            newRecipe.requiredItem[2].stack = 0x10;
            newRecipe.requiredItem[3].SetDefaults(0xd1, false);
            newRecipe.requiredItem[3].stack = 12;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(230, false);
            newRecipe.requiredItem[0].SetDefaults(0xb5, false);
            newRecipe.requiredItem[0].stack = 1;
            newRecipe.requiredItem[1].SetDefaults(180, false);
            newRecipe.requiredItem[1].stack = 1;
            newRecipe.requiredItem[2].SetDefaults(0x14b, false);
            newRecipe.requiredItem[2].stack = 8;
            newRecipe.requiredItem[3].SetDefaults(210, false);
            ...
            addRecipe();
            newRecipe.createItem.SetDefaults(0x185, false);
            newRecipe.requiredItem[0].SetDefaults(0x20f, false);
            newRecipe.requiredItem[1].SetDefaults(0x210, false);
            newRecipe.requiredItem[2].SetDefaults(0x209, false);
            newRecipe.requiredItem[2].stack = 10;
            newRecipe.requiredItem[3].SetDefaults(520, false);
            newRecipe.requiredItem[3].stack = 10;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x17d, false);
            newRecipe.requiredItem[0].SetDefaults(0x16c, false);
            newRecipe.requiredItem[0].stack = 3;
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults("Cobalt Helmet");
            newRecipe.requiredItem[0].SetDefaults(0x17d, false);
            newRecipe.requiredItem[0].stack = 10;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            ...
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x219, false);
            newRecipe.requiredItem[0].SetDefaults(0x17d, false);
            newRecipe.requiredItem[0].stack = 10;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x17e, false);
            newRecipe.requiredItem[0].SetDefaults(0x16d, false);
            newRecipe.requiredItem[0].stack = 4;
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults("Mythril Helmet");
            newRecipe.requiredItem[0].SetDefaults(0x17e, false);
            newRecipe.requiredItem[0].stack = 10;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            ...
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x20d, false);
            newRecipe.requiredItem[0].SetDefaults(0x17e, false);
            newRecipe.requiredItem[0].stack = 10;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x187, false);
            newRecipe.requiredItem[0].SetDefaults(0x16e, false);
            newRecipe.requiredItem[0].stack = 5;
            newRecipe.requiredTile[0] = 0x85;
            addRecipe();
            newRecipe.createItem.SetDefaults("Adamantite Helmet");
            newRecipe.requiredItem[0].SetDefaults(0x187, false);
            newRecipe.requiredItem[0].stack = 12;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x192, false);
            newRecipe.requiredItem[0].SetDefaults(0x187, false);
            newRecipe.requiredItem[0].stack = 12;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            ...
            newRecipe.requiredItem[0].SetDefaults(0x187, false);
            newRecipe.requiredItem[0].stack = 0x18;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults("Adamantite Leggings");
            newRecipe.requiredItem[0].SetDefaults(0x187, false);
            newRecipe.requiredItem[0].stack = 0x12;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            ...
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1e2, false);
            newRecipe.requiredItem[0].SetDefaults(0x187, false);
            newRecipe.requiredItem[0].stack = 12;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            ...
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x20c, false);
            newRecipe.requiredItem[0].SetDefaults(0x16e, false);
            newRecipe.requiredItem[0].stack = 30;
            newRecipe.requiredItem[1].SetDefaults(0xdd, false);
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x22f, false);
            newRecipe.requiredItem[0].SetDefaults(0x174, false);
            newRecipe.requiredItem[1].SetDefaults(0x179, false);
            newRecipe.requiredItem[2].SetDefaults(0x191, false);
            newRecipe.requiredItem[3].SetDefaults(0x225, false);
            newRecipe.requiredItem[3].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x22e, false);
            newRecipe.requiredItem[0].SetDefaults(0x173, false);
            newRecipe.requiredItem[1].SetDefaults(0x178, false);
            newRecipe.requiredItem[2].SetDefaults(400, false);
            newRecipe.requiredItem[3].SetDefaults(0x225, false);
            newRecipe.requiredItem[3].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x229, false);
            newRecipe.requiredItem[0].SetDefaults(0x175, false);
            newRecipe.requiredItem[1].SetDefaults(0x17a, false);
            newRecipe.requiredItem[2].SetDefaults(0x192, false);
            newRecipe.requiredItem[3].SetDefaults(0x225, false);
            newRecipe.requiredItem[3].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x227, false);
            newRecipe.requiredItem[0].SetDefaults(0x176, false);
            newRecipe.requiredItem[1].SetDefaults(0x17b, false);
            newRecipe.requiredItem[2].SetDefaults(0x193, false);
            newRecipe.requiredItem[3].SetDefaults(0x224, false);
            newRecipe.requiredItem[3].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x228, false);
            newRecipe.requiredItem[0].SetDefaults(0x177, false);
            newRecipe.requiredItem[1].SetDefaults(380, false);
            newRecipe.requiredItem[2].SetDefaults(0x194, false);
            newRecipe.requiredItem[3].SetDefaults(0x223, false);
            newRecipe.requiredItem[3].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x243, false);
            newRecipe.requiredItem[0].SetDefaults(0x181, false);
            newRecipe.requiredItem[1].SetDefaults(0x182, false);
            newRecipe.requiredItem[2].SetDefaults(0x184, false);
            newRecipe.requiredItem[3].SetDefaults(0x17f, false);
            newRecipe.requiredItem[4].SetDefaults(0x180, false);
            newRecipe.requiredItem[5].SetDefaults(0x183, false);
            newRecipe.requiredItem[6].SetDefaults(0x223, false);
            newRecipe.requiredItem[6].stack = 5;
            newRecipe.requiredItem[7].SetDefaults(0x224, false);
            newRecipe.requiredItem[7].stack = 5;
            newRecipe.requiredItem[8].SetDefaults(0x225, false);
            newRecipe.requiredItem[8].stack = 5;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x242, false);
            newRecipe.requiredItem[0].SetDefaults(0x1b3, false);
            newRecipe.requiredItem[1].SetDefaults(0x1b4, false);
            newRecipe.requiredItem[2].SetDefaults(0x1e1, false);
            newRecipe.requiredItem[3].SetDefaults(0x225, false);
            newRecipe.requiredItem[3].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x170, false);
            newRecipe.requiredItem[0].SetDefaults(0x1e3, false);
            newRecipe.requiredItem[1].SetDefaults(0x1e4, false);
            newRecipe.requiredItem[2].SetDefaults(0x1e2, false);
            newRecipe.requiredItem[3].SetDefaults(0x224, false);
            newRecipe.requiredItem[3].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(550, false);
            newRecipe.requiredItem[0].SetDefaults(0x219, false);
            newRecipe.requiredItem[1].SetDefaults(390, false);
            newRecipe.requiredItem[2].SetDefaults(0x196, false);
            newRecipe.requiredItem[3].SetDefaults(0x223, false);
            newRecipe.requiredItem[3].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x215, false);
            newRecipe.requiredItem[0].SetDefaults(0x62, false);
            newRecipe.requiredItem[1].SetDefaults(0x144, false);
            newRecipe.requiredItem[2].SetDefaults(0x13f, false);
            newRecipe.requiredItem[2].stack = 5;
            newRecipe.requiredItem[3].SetDefaults(0x224, false);
            newRecipe.requiredItem[3].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x231, false);
            newRecipe.requiredItem[0].SetDefaults(0x17d, false);
            newRecipe.requiredItem[0].stack = 10;
            newRecipe.requiredItem[1].SetDefaults(0x17e, false);
            newRecipe.requiredItem[1].stack = 10;
            ...
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1fa, false);
            newRecipe.requiredItem[0].SetDefaults(20, false);
            newRecipe.requiredItem[0].stack = 20;
            newRecipe.requiredItem[1].SetDefaults(0x16, false);
            newRecipe.requiredItem[1].stack = 20;
            newRecipe.requiredItem[2].SetDefaults(0x144, false);
            newRecipe.requiredItem[3].SetDefaults(0x20a, false);
            newRecipe.requiredItem[3].stack = 0x23;
            newRecipe.requiredItem[4].SetDefaults(0x223, false);
            newRecipe.requiredItem[4].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1ee, false);
            newRecipe.requiredItem[0].SetDefaults(0x1fc, false);
            newRecipe.requiredItem[1].SetDefaults(0x1f6, false);
            newRecipe.requiredItem[1].stack = 0x19;
            newRecipe.requiredItem[2].SetDefaults(0x209, false);
            newRecipe.requiredItem[2].stack = 15;
            newRecipe.requiredItem[3].SetDefaults(0x13, false);
            newRecipe.requiredItem[3].stack = 15;
            newRecipe.requiredItem[4].SetDefaults(0x225, false);
            newRecipe.requiredItem[4].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1a9, false);
            newRecipe.requiredItem[0].SetDefaults(0x1fb, false);
            newRecipe.requiredItem[1].SetDefaults(0x1f5, false);
            ...
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1f1, false);
            newRecipe.requiredItem[0].SetDefaults(0x113, false);
            newRecipe.requiredItem[0].stack = 15;
            newRecipe.requiredItem[1].SetDefaults(0x13f, false);
            newRecipe.requiredItem[1].stack = 5;
            newRecipe.requiredItem[2].SetDefaults(0x105, false);
            newRecipe.requiredItem[2].stack = 15;
            newRecipe.requiredItem[3].SetDefaults(520, false);
            newRecipe.requiredItem[3].stack = 5;
            newRecipe.requiredItem[4].SetDefaults(0x209, false);
            newRecipe.requiredItem[4].stack = 5;
            newRecipe.requiredItem[5].SetDefaults(0x223, false);
            newRecipe.requiredItem[5].stack = 20;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1ef, false);
            newRecipe.requiredItem[0].SetDefaults(0x1f6, false);
            newRecipe.requiredItem[0].stack = 30;
            newRecipe.requiredItem[1].SetDefaults(0x20e, false);
            newRecipe.requiredItem[1].stack = 4;
            newRecipe.requiredItem[2].SetDefaults(0x1f5, false);
            ...
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1ed, false);
            newRecipe.requiredItem[0].SetDefaults(320, false);
            newRecipe.requiredItem[0].stack = 10;
            newRecipe.requiredItem[1].SetDefaults(0x23f, false);
            newRecipe.requiredItem[1].stack = 0x19;
            newRecipe.requiredItem[2].SetDefaults(520, false);
            newRecipe.requiredItem[2].stack = 30;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1ec, false);
            newRecipe.requiredItem[0].SetDefaults(320, false);
            newRecipe.requiredItem[0].stack = 10;
            newRecipe.requiredItem[1].SetDefaults(0x23f, false);
            newRecipe.requiredItem[1].stack = 0x19;
            ...
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x18a, false);
            newRecipe.requiredItem[0].SetDefaults(0xbb, false);
            newRecipe.requiredItem[1].SetDefaults(0x10c, false);
            newRecipe.requiredTile[0] = 0x72;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x18b, false);
            newRecipe.requiredItem[0].SetDefaults(0x11, false);
            newRecipe.requiredItem[1].SetDefaults(0x12, false);
            newRecipe.requiredItem[2].SetDefaults(0x189, false);
            newRecipe.requiredTile[0] = 0x72;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x18c, false);
            newRecipe.requiredItem[0].SetDefaults(0x9e, false);
            newRecipe.requiredItem[1].SetDefaults(0xc1, false);
            newRecipe.requiredTile[0] = 0x72;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x18d, false);
            newRecipe.requiredItem[0].SetDefaults(0x9c, false);
            newRecipe.requiredItem[1].SetDefaults(0xc1, false);
            newRecipe.requiredTile[0] = 0x72;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x18f, false);
            newRecipe.requiredItem[0].SetDefaults(0x35, false);
            newRecipe.requiredItem[1].SetDefaults(0x9f, false);
            newRecipe.requiredTile[0] = 0x72;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x195, false);
            newRecipe.requiredItem[0].SetDefaults(0x36, false);
            newRecipe.requiredItem[1].SetDefaults(0x80, false);
            newRecipe.requiredTile[0] = 0x72;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x22b, false);
            newRecipe.requiredItem[0].SetDefaults(0xdf, false);
            newRecipe.requiredItem[1].SetDefaults(0xbd, false);
            newRecipe.requiredTile[0] = 0x72;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x1ff, false);
            newRecipe.requiredItem[0].SetDefaults(3, false);
            newRecipe.requiredItem[1].SetDefaults(530, false);
            addRecipe();
            newRecipe.createItem.SetDefaults(0x200, false);
            newRecipe.requiredItem[0].SetDefaults(0x1a, false);
            newRecipe.requiredItem[0].stack = 4;
            newRecipe.requiredItem[1].SetDefaults(530, false);
            addRecipe();
            newRecipe.createItem.SetDefaults(580, false);
            newRecipe.requiredItem[0].SetDefaults(0xa7, false);
            newRecipe.requiredItem[0].stack = 3;
            newRecipe.requiredItem[1].SetDefaults("Wire");
            addRecipe();
            newRecipe.createItem.SetDefaults(0x245, false);
            newRecipe.requiredItem[0].SetDefaults("Iron Bar");
            newRecipe.requiredItem[0].stack = 10;
            newRecipe.requiredItem[1].SetDefaults("Wire");
            newRecipe.requiredItem[1].stack = 2;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x246, false);
            newRecipe.requiredItem[0].SetDefaults("Iron Bar");
            newRecipe.requiredItem[0].stack = 10;
            newRecipe.requiredItem[1].SetDefaults("Wire");
            newRecipe.requiredItem[1].stack = 2;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x247, false);
            newRecipe.requiredItem[0].SetDefaults(0x11, false);
            newRecipe.requiredItem[1].SetDefaults("Iron Bar");
            newRecipe.requiredItem[1].stack = 5;
            ...
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x248, false);
            newRecipe.requiredItem[0].SetDefaults(0x10, false);
            newRecipe.requiredItem[1].SetDefaults("Iron Bar");
            newRecipe.requiredItem[1].stack = 5;
            newRecipe.requiredItem[2].SetDefaults("Wire");
            newRecipe.requiredItem[2].stack = 1;
            newRecipe.requiredTile[0] = 0x10;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x249, false);
            ...
            newRecipe.requiredTile[0] = 0x72;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x235, false);
            newRecipe.requiredItem[0].SetDefaults(0x232, false);
            newRecipe.requiredItem[1].SetDefaults(0x233, false);
            newRecipe.requiredItem[2].SetDefaults(0x234, false);
            newRecipe.requiredItem[3].SetDefaults(0x236, false);
            newRecipe.requiredItem[4].SetDefaults(0x237, false);
            newRecipe.requiredItem[5].SetDefaults(0x238, false);
            newRecipe.requiredItem[6].SetDefaults(0x239, false);
            newRecipe.requiredItem[7].SetDefaults(570, false);
            newRecipe.requiredItem[8].SetDefaults(0x23b, false);
            newRecipe.requiredItem[9].SetDefaults(0x23c, false);
            newRecipe.requiredItem[10].SetDefaults(0x23d, false);
            newRecipe.requiredItem[11].SetDefaults(0x23e, false);
            newRecipe.requiredTile[0] = 0x72;
            addRecipe();
            ...
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x206, false);
            newRecipe.requiredItem[0].SetDefaults(0x213, false);
            newRecipe.requiredItem[1].SetDefaults(0x1f6, false);
            newRecipe.requiredItem[1].stack = 30;
            newRecipe.requiredItem[2].SetDefaults(520, false);
            newRecipe.requiredItem[2].stack = 20;
            newRecipe.requiredTile[0] = 0x65;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x207, false);
            newRecipe.requiredItem[0].SetDefaults(0x213, false);
            newRecipe.requiredItem[1].SetDefaults(0x20a, false);
            newRecipe.requiredItem[1].stack = 30;
            newRecipe.requiredItem[2].SetDefaults(0x209, false);
            ...
            newRecipe.requiredItem[0].SetDefaults(0x17, false);
            newRecipe.requiredItem[0].stack = 0x63;
            newRecipe.requiredItem[1].SetDefaults(0x108, false);
            newRecipe.requiredTile[0] = 0x1a;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x220, false);
            newRecipe.requiredItem[0].SetDefaults(0x26, false);
            newRecipe.requiredItem[0].stack = 3;
            newRecipe.requiredItem[1].SetDefaults(20, false);
            newRecipe.requiredItem[1].stack = 5;
            newRecipe.requiredItem[2].SetDefaults(0x16, false);
            newRecipe.requiredItem[2].stack = 5;
            newRecipe.requiredItem[3].SetDefaults(520, false);
            newRecipe.requiredItem[3].stack = 7;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x22c, false);
            newRecipe.requiredItem[0].SetDefaults(0x44, false);
            newRecipe.requiredItem[0].stack = 6;
            newRecipe.requiredItem[1].SetDefaults(20, false);
            newRecipe.requiredItem[1].stack = 5;
            newRecipe.requiredItem[2].SetDefaults(0x16, false);
            newRecipe.requiredItem[2].stack = 5;
            newRecipe.requiredItem[3].SetDefaults(0x209, false);
            newRecipe.requiredItem[3].stack = 7;
            newRecipe.requiredTile[0] = 0x86;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x22d, false);
            newRecipe.requiredItem[0].SetDefaults(0x9a, false);
            newRecipe.requiredItem[0].stack = 30;
            newRecipe.requiredItem[1].SetDefaults(20, false);
            newRecipe.requiredItem[1].stack = 5;
            ...
            if (ZidoMod.freeCrafting)
            {
                for (int i = 0; i < numRecipes; i++)
                {
                    ...
                    {
                        Main.recipe[i].requiredItem[j] = new Item();
                        Main.recipe[i].requiredTile[j] = -1;
                    }
                    Main.recipe[i].needWater = false;
                }
            }
            for (int i = 0; i < numRecipes; i++)
            {
