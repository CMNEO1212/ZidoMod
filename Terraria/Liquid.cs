namespace Terraria
{
    ...
    public class Liquid
    {
        ...
        public void Update()
        {
            ...
            {
                byte type = Main.tile[this.x, this.y].type;
                this.kill = 9;
            }
            else
            {
                ...
                {
                    byte num3 = 2;
                    if (Main.tile[this.x, this.y].liquid < num3)
                    {
                        num3 = Main.tile[this.x, this.y].liquid;
                    }
                    Tile tile1 = Main.tile[this.x, this.y];
                    tile1.liquid = (byte) (tile1.liquid - num3);
                }
                    ...
                    if (Main.tile[this.x, this.y].liquid > 0)
                    {
                        ...
                        if (flag && flag2)
                        {
                            if (flag3 && flag4)
                            {
                                ...
                                if (flag5 && flag6)
                                {
                                    num2 = ((((((Main.tile[this.x - 1, this.y].liquid + Main.tile[this.x + 1, this.y].liquid) + Main.tile[this.x - 2, this.y].liquid) + Main.tile[this.x + 2, this.y].liquid) + Main.tile[this.x - 3, this.y].liquid) + Main.tile[this.x + 3, this.y].liquid) + Main.tile[this.x, this.y].liquid) + num4;
                                    ...
                                    if ((num5 != 6) || (Main.tile[this.x, this.y - 1].liquid <= 0))
                                    {
                                ...
                                {
                                    int num6 = 0;
                                    num2 = ((((Main.tile[this.x - 1, this.y].liquid + Main.tile[this.x + 1, this.y].liquid) + Main.tile[this.x - 2, this.y].liquid) + Main.tile[this.x + 2, this.y].liquid) + Main.tile[this.x, this.y].liquid) + num4;
                                    ...
                                    if ((num6 != 4) || (Main.tile[this.x, this.y - 1].liquid <= 0))
                                    {
                                        Main.tile[this.x, this.y].liquid = (byte) num2;
                                    }
                                }
                            ...
                            {
                                num2 = (((Main.tile[this.x - 1, this.y].liquid + Main.tile[this.x + 1, this.y].liquid) + Main.tile[this.x - 2, this.y].liquid) + Main.tile[this.x, this.y].liquid) + num4;
                            ...
                            {
                                num2 = ((Main.tile[this.x - 1, this.y].liquid + Main.tile[this.x + 1, this.y].liquid) + Main.tile[this.x, this.y].liquid) + num4;
                        ...
                        {
                            num2 = (Main.tile[this.x - 1, this.y].liquid + Main.tile[this.x, this.y].liquid) + num4;
