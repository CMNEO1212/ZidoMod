    ...
    public class Chest
    {
        ...
        public void SetupShop(int type)
        {
            ...
            if (type == 1)
            {
                ...
                if (Main.hardMode)
                {
                    this.item[index].SetDefaults(0x1e8, false);
                    index++;
                }
            }
            else if (type == 2)
            {
                ...
                if (Main.hardMode)
                {
                    this.item[num3].SetDefaults(0x216, false);
                }
                num3++;
            }
            else if (type == 3)
            {
                ...
                if (Main.hardMode)
                {
                    this.item[num4].SetDefaults(0x171, false);
                }
                num4++;
            }
            else if (type == 4)
            {
                ...
                if (Main.hardMode)
                {
                    this.item[num5].SetDefaults("Hellfire Arrow");
                }
                num5++;
            }
            else if (type == 5)
            {
                ...
                if (NPC.downedClown)
                {
                    this.item[num6].SetDefaults(0x1f7, false);
                    num6++;
                    this.item[num6].SetDefaults(0x1f8, false);
                    num6++;
                    this.item[num6].SetDefaults(0x1f9, false);
                    num6++;
                }
                if (Main.bloodMoon)
                {
            ...
            {
                int num7 = 0;
                this.item[num7].SetDefaults(0x80, false);
                num7++;
                this.item[num7].SetDefaults(0x1e6, false);
                num7++;
                this.item[num7].SetDefaults(0x18e, false);
                num7++;
                this.item[num7].SetDefaults(0x54, false);
                num7++;
                this.item[num7].SetDefaults(0x197, false);
                num7++;
                this.item[num7].SetDefaults(0xa1, false);
                num7++;
            }
            else if (type == 7)
            {
                int num8 = 0;
                this.item[num8].SetDefaults(0x1e7, false);
                num8++;
                this.item[num8].SetDefaults(0x1f0, false);
                num8++;
                this.item[num8].SetDefaults(500, false);
                num8++;
                this.item[num8].SetDefaults(0x1fb, false);
                num8++;
                this.item[num8].SetDefaults(0x1fc, false);
                num8++;
                this.item[num8].SetDefaults(0x213, false);
                num8++;
                this.item[num8].SetDefaults(0x240, false);
                num8++;
            }
            else if (type == 8)
            {
                int num9 = 0;
                this.item[num9].SetDefaults(0x1fd, false);
                num9++;
                this.item[num9].SetDefaults(510, false);
                num9++;
                this.item[num9].SetDefaults(530, false);
                num9++;
                this.item[num9].SetDefaults(0x201, false);
                num9++;
                this.item[num9].SetDefaults(0x21a, false);
                num9++;
                this.item[num9].SetDefaults(0x211, false);
                num9++;
                this.item[num9].SetDefaults(0x21d, false);
                num9++;
                this.item[num9].SetDefaults(0x21e, false);
                num9++;
                this.item[num9].SetDefaults(0x21f, false);
                num9++;
            }
        }
