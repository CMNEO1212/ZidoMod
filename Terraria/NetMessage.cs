        ...
        public static void SendData(int msgType, int remoteClient = -1, int ignoreClient = -1, string text = "", int number = 0, float number2 = 0f, float number3 = 0f, float number4 = 0f, int number5 = 0)
        {
            ...
            lock (buffer[index])
            {
                ...
                else if (msgType == 13)
                {
                    ...
                    if (Main.player[num24].controlUseItem && !ZidoMod.noAnimateSend)
                    {
                ...
                else if (msgType == 0x10)
                {
                    ...
                    {
                        if (Main.player[num29].statLife > 400)
                            buffer66 = BitConverter.GetBytes((short)400);
                        else if(Main.player[num29].statLife > Main.player[num29].statLifeMax)
                            buffer66 = BitConverter.GetBytes((short)Main.player[num29].statLifeMax);
                        else
                            buffer66 = BitConverter.GetBytes((short)Main.player[num29].statLife);

                        if (Main.player[num29].statLifeMax > 400)
                            buffer67 = BitConverter.GetBytes((short)400);
                        else
                            buffer67 = BitConverter.GetBytes((short)Main.player[num29].statLifeMax);
                    }
                ...
                else if (msgType == 20)
                {
                    ...
                    for (int j = num36; j < (num36 + num35); j++)
                    {
                        for (int k = num37; k < (num37 + num35); k++)
                        {
                            ...
                            if ((Main.tile[j, k].liquid > 0) && (Main.netMode == 2 || ZidoMod.bypassNetMode))
                            {
                                num40 = (byte) (num40 + 8);
                            }
                ...
                else if (msgType == 0x1b && !ZidoMod.noProjectileSend)
                {
                ...
                else if (msgType == 0x2a)
                {
                    ...
                    if (ZidoMod.capNetStats)
                    {
                        if (Main.player[num75].statMana > 400)
                            buffer179 = BitConverter.GetBytes((short)400);
                        else if (Main.player[num75].statMana > Main.player[num75].statManaMax)
                            buffer179 = BitConverter.GetBytes((short)Main.player[num75].statManaMax);
                        else
                            buffer179 = BitConverter.GetBytes((short)Main.player[num75].statMana);

                        if (Main.player[num75].statManaMax > 400)
                            buffer180 = BitConverter.GetBytes((short)400);
                        else
                            buffer180 = BitConverter.GetBytes((short)Main.player[num75].statManaMax);
                    }
                        ...
                        for (int num100 = 0; num100 < 0x100; num100++)
                        {
                            if (((num100 != ignoreClient) && (buffer[num100].broadcast || ((Netplay.serverSock[num100].state >= 3) && (msgType == 10)))) && Netplay.serverSock[num100].tcpClient.Connected)
                            {
                                ...
                                else
                                {
                                    ...
                                    rectangle4 = new Rectangle((int) Main.npc[num99].position.X, (int) Main.npc[num99].position.Y, Main.npc[num99].width, Main.npc[num99].height);
                                    rectangle4.X -= 0xbb8;
                                    rectangle4.Y -= 0xbb8;
                                    rectangle4.Width += 0x1770;
                                    rectangle4.Height += 0x1770;
                        ...
                        for (int num102 = 0; num102 < 0x100; num102++)
                        {
                            if (((num102 != ignoreClient) && (buffer[num102].broadcast || ((Netplay.serverSock[num102].state >= 3) && (msgType == 10)))) && Netplay.serverSock[num102].tcpClient.Connected)
                            {
                                ...
                                if (Main.player[num101].netSkip > 0)
                                {
                                    ...
                                    rectangle6 = new Rectangle((int)Main.player[num101].position.X, (int)Main.player[num101].position.Y, Main.player[num101].width, Main.player[num101].height);
                                    rectangle6.X -= 0x9c4;
                                    rectangle6.Y -= 0x9c4;
                                    rectangle6.Width += 0x1388;
                                    rectangle6.Height += 0x1388;
                        ...
                        for (int num104 = 0; num104 < 0x100; num104++)
                        {
                            if (((num104 != ignoreClient) && (buffer[num104].broadcast || ((Netplay.serverSock[num104].state >= 3) && (msgType == 10)))) && Netplay.serverSock[num104].tcpClient.Connected)
                            {
                                ...
                                else
                                {
                                    ...
                                    rectangle8 = new Rectangle((int)Main.projectile[num103].position.X, (int)Main.projectile[num103].position.Y, Main.projectile[num103].width, Main.projectile[num103].height);
                                    rectangle8.X -= 0x1388;
                                    rectangle8.Y -= 0x1388;
                                    rectangle8.Width += 0x2710;
                                    rectangle8.Height += 0x2710;
